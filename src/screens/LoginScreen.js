// LoginScreen.js — "Welcome Back!" auth screen.
...
const THREAD_COLOR = 'rgba(124,75,215,0.55)';
  ...
  return (
    <View style={f.fieldWrap}>
      ...
      <View style={[f.inputRow, focused && f.inputRowFocused]}>
        {icon && (
          <Ionicons name={icon} size={18} color="rgba(91,45,142,0.6)" style={f.icon} />
        )}
        <TextInput
          style={f.input}
...
export default function LoginScreen({ navigation, route }) {
  ...
  const handleLogin = () => {
    navigation.navigate('Onboarding', { onComplete });
  };
      ...
      <View style={[s.root, { paddingTop: insets.top }]}>
        ...
        >
          ...
          <View style={s.form}>
            ...
            <TouchableOpacity style={s.primaryBtn} onPress={handleLogin} activeOpacity={0.85}>
            ...
            <View style={s.switchRow}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('CreateAccount', { onComplete })}>
